...
const config = {
    serverInfo: {
        ...
        serverName: "SKKYDEVIL Smp", /*Server name*/
        serverIp: "skydevil.theserver.tk:25388", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1192866708621361193" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
    ...
    */
    ...
    adminTeamPage: {
        leaders: [
            {
                inGameName: "darknessking",
                rank: "Owner",
                skinUrlOrPathToFile: "https://media.discordapp.net/attachments/1193413487637045279/1195397809227173928/download_6.png?ex=65b3d7f7&is=65a162f7&hm=9e314b1d3f4cd137a6695102306e611492a831af70c82022ab39ffd5c6a40f01&=&format=webp&quality=lossless&width=220&height=294",
        ...
        developers: [
            {
                inGameName: "None",
                rank: "Developer",
                skinUrlOrPathToFile: "https://media.discordapp.net/attachments/1193413487637045279/1195398935041294396/download_7.png?ex=65b3d903&is=65a16403&hm=7576029f41d9e9728797255c797ce8436423f1ef3d4293ea0737b986da247029&=&format=webp&quality=lossless&width=240&height=320",
                rankColor: ""
            },
            {
                inGameName: "None",
        ...
        helpers: [
            {
                inGameName: "none",
                rank: "Helper++",
                skinUrlOrPathToFile: "https://media.discordapp.net/attachments/1193413487637045279/1195398935041294396/download_7.png?",
                rankColor: ""
            },
            {
                inGameName: "none",
